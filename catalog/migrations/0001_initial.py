# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-30 20:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='book instance id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Science Fciton, French Poetry etc.)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
